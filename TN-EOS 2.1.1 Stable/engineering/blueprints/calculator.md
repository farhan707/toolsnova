...
Result Summary should present the calculator's primary outputs through a concise visual summary before any detailed calculation breakdown.

The exact summary metrics are domain-specific and should reflect the calculator's primary decision-making outputs.
...
✓ Prioritize primary results before detailed calculation output
